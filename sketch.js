...
function setup() {
	...
	tree=new Tree(800,550,50,100);
	

	stone=new Stone(140,600,20,20);

	boy=createSprite(200,900,10,10);
	...
	mango10=new Mango(800,250,20);
	mango11=new Mango(900,250,20);
	mango12=new Mango(1000,250,20);
	mango13=new Mango(1000,150,20);
	mango14=new Mango(900,150,20);
  
    launcher=new Launcher(stone.body,{x:160,y:850});
